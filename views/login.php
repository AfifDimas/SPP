...
<?php include "V_head.php"; ?>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="" required autocomplete="off">
  ...
  <script type="text/javascript">
    ...
    function login() {
      ...
      var url = "<?= BASE_URL; ?>back/handle_login.php";
      ...
      $.ajax({
        ...
        success:function(res) {
          ...
          if (res == "login berhasil") {
            location.replace("<?= BASE_URL; ?>views/index.php");
          }
        },
        error:function(res){
          console.log(err);
